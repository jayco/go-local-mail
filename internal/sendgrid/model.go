...
// SGItem for document storage in mongo
type SGItem struct {
	ID         string    `bson:"_id,omitempty"`
	Recipients []string  `bson:"recipients,omitempty,"`
	Subject    string    `bson:"subject,omitempty,"`
	Full       SGMailV3  `bson:"full,omitempty,"`
	HTML       string    `bson:"html,omitempty,"`
	Text       string    `bson:"text,omitempty,"`
	URL        string    `bson:"url,omitempty,"`
	Unused     []string  `bson:"unused,omitempty,"`
	CreatedAt  time.Time `bson:"createdAt,omitempty,"`
}

// TAKEN FROM https://github.com/sendgrid/sendgrid-go/blob/d1c72cf7d640fb33478848959485bb0cf916809b/helpers/mail/mail_v3.go
...
// FooterSetting holds enable/disable settings
...
// NewEmail ...
func NewEmail(name string, email string) *Email {
